...
{
    public class DistributorManagementModel:Common
    {
        ...
        [StringLength(10, MinimumLength = 10, ErrorMessage = "User Number Invalid")]
        ...
        [StringLength(10, MinimumLength = 10, ErrorMessage = "Contact Person Number Invalid")]
