...
{
    public class SubDistributorModel:Common
    {
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Contract Date is required")]
        ...
        //[Required(AllowEmptyStrings = false, ErrorMessage = "Agent Email is required")]
        [Display(Name = "Agent Latitude")]
        public string AgentLatitude { get; set; }
        //[Required(AllowEmptyStrings = false, ErrorMessage = "Agent Email is required")]
        [Display(Name = "Agent Longitude")]
        public string AgentLongitude { get; set; }
        [Required(AllowEmptyStrings = false, ErrorMessage = "Credit Limit is required")]
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Temporary Provience is required")]
