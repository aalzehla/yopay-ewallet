...
namespace ewallet.repository
{
    ...
    public class RepositoryDao
    {
        ...
        public string LogError(Exception Apperr, string page, string UserName, string IpAddress)
        {
            ...
            var eSql = "sproc_errors @flag= 'i' ";
            eSql += ", @error_Page=" + FilterString(errPage);
            eSql += ", @error_Msg=" + FilterString("Message => " + err.Message + " and LineNumber => " + line.ToString());
            eSql += ", @error_Detail=" + FilterString(errDetails);
            eSql += ", @user=" + FilterString(UserName);
            eSql += ", @ip_address=" + FilterString(IpAddress);
