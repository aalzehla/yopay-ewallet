...
/****** Object:  Table [dbo].[tbl_agent_detail]    Script Date: 06/05/2020 18:35:18 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbl_agent_detail]') AND type in (N'U'))
