...
/****** Object:  StoredProcedure [dbo].[sproc_get_dropdown_list]    Script Date: 4/24/2020 12:17:11 AM ******/
SET ANSI_NULLS ON
GO
...
*/    
 ...
 else if @flag = '027' or @flag = 'productCategory'    
 begin    
 select isnull(static_data_label,'') as productCategory  
   ,static_data_label    
  from tbl_Static_data(nolock)    
  where sdata_type_id = 8;    
 end    
    
 else if @flag = '028' or @flag = 'productType'    
 begin    
  select isnull(static_data_value+'|'+static_data_label,'') as productTypeId    
   ,static_data_label    
  from tbl_Static_data(nolock)    
 ...
 begin    
  ...
  else if @flag ='030' or @flag = 'country'    
 begin    
  select static_data_value   as value  
   ,static_data_label   as text  
  from tbl_Static_data(nolock)    
